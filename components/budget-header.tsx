      ...
      <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="budget">
                    Budget for {format(currentDate, "MMMM yyyy")}
                  </Label>
        ...
        {currentBudget ? (
          <div className="grid grid-cols-3 gap-4">
            ...
            <div
              className={`rounded-lg p-3 flex flex-col ${isOverBudget ? "bg-red-100 dark:bg-red-900/20" : "bg-green-100 dark:bg-green-900/20"}`}
            >
              <span className="text-xs text-muted-foreground mb-1 flex items-center">
                <TrendingUp size={14} className="mr-1" /> Remaining
              </span>
              <span
                className={`text-lg font-semibold ${isOverBudget ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}`}
              >
          ...
          <div className="bg-muted/50 rounded-lg p-4 text-center">
            <p className="text-muted-foreground">
              Set a budget for this month to track your expenses
            </p>
          </div>
        )}
      </div>
