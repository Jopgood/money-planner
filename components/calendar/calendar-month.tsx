...
export function CalendarMonth({ currentDate, onSelectDate }: CalendarMonthProps) {
            ...
            >
              <span 
                className={cn(
                  ...
                  {
                    "bg-primary text-primary-foreground font-medium": isCurrentDay,
              ...
              {hasExpenses && (
                <div className="mt-auto w-full">
                  <div className={cn(
                    ...
                    totalAmount > 100 ? "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300" :
                    totalAmount > 50 ? "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300" :
